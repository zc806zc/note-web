...
duma.BeautifyScrollBar.prototype = {
    ...
    sethandle:function() {                //当内容超多时设置拖拽条子的最小高度
		...
		this.handleHeight = this.handleMinHeight; this.handle.style.height = this.handleMinHeight + "px";
		// 不理解下面这段直接注释
...
;(function($) {
    ...
    $.fn.doPost = function(options){
        ...
        options = $.extend(true, options, {"form" : this});
    ...
    $.istrackOpen = function(coId){
        ...
        var data = $wq.jsonToArr({"query.company_id":coId});
    ...
    $.extend($weqia, {
        ...
        defaultAjax:function(req){
            ...
            $wq.doAjax({
                ...
                data: data,
                success: function(result){
                    $.dialog({width: '250px',height:"80px",title:"提示",time:3,icon: 'success.gif',content:"<h2>操作成功！</h2>",min:false,max:false});
                    if(onSuccess){
                        onSuccess.call(this,result);
                    }
                },fail : function(result){
                    $.dialog({width: '250px',height:"80px",title:"提示",icon: 'error.gif',time:3,content:"<h3>"+result.errorMsg+"</h3>",min:false,max:false});
                },error: function(){
                    $.dialog({width: '250px',height:"80px",title:"提示",icon: 'error.gif',time:3,content:"<h3>网络或系统异常，请稍候重试！</h3>",min:false,max:false});
                }
            });
        },
...
//						alert('请求出错!');
        ...
        getSystemTime : function(){
            ...
            var result = this.getJsonData({url:url});
            if(result)
        ...
        highBlink : function(target, color){
            $(target).css({"background-color": color, "opacity": "0.8"}).
            animate({opacity:'0.3'},200).
            animate({opacity:'0.8'},200).
            animate({opacity:'0.3'},200,function(){
...
//						alert('请求出错!');
    ...
    var wqFileHandler = $wq.fileHandler = {
        ...
        getSignUrl: function(url, th){
            var data = $wq.jsonToArr({"url": url, "th": th});
            url = $wq.getJsonData({"url":"/common/signUrl.htm", "data":data});
            return url;
        },

        getSuffixSignUrl: function(url){
            var data = $wq.jsonToArr({"url": url});
            url = $wq.getJsonData({"url":"/common/suffixSignUrl.htm", "data":data});
            return url;
        },

        getSignUrlByDownload: function(url, th){
            var data = $wq.jsonToArr({"url": url, "th": th});
            url = $wq.getJsonData({"url":"/common/getSignUrlByDownload.htm", "data":data});
            return url;
        },

        getSignUrlByDownloadWithName: function(url, th,downloadName){
            var data = $wq.jsonToArr({"url": url, "th": th,"downloadName":downloadName});
            url = $wq.getJsonData({"url":"/common/getSignUrlByDownloadWithName.htm", "data":data});
            return url;
        },
    ...
    $.extend(WeqiaUploader, {
        ...
        defaults: {
            itype: 1000,									/* 业务类型。*/
            fileCount: 9,									/* 允许上传的文件数*/
            fileSize: 300,									/* 允许上传的文件大小,单位M*/
            replace: false,									/* 允许替换文件*/
            multiple: true,									/* 多文件上传模式 */
            showView: true,									/* 是否显示视图 */
            view: null,										/* 文件视图 */
            formable:true,									/* 支持表单, 默认为true*/
            formEl: null,									/* 表单元素 , formable为 true,提供表单元素*/
            allowedTypes: "all",							/* 允许上传的文件类型 */
            uploadElClass: "ts_wx1",						/* 上传控件样式 */
            actionUrl: "/common/upload.htm",				/* 文件上传URL*/
            imageServer: "",                                /*20150420 3为拉伸图   缩略图修改为4截取图   原th:3*/
            th: 4	,										/* 展示的缩略图, 默认为3（180*180）*/
            inputFileClass: "file_formupoadfile"	,		/* 文件输入控件样式*/
            order: 1,										/* 新增文件顺序，1正常顺序，2倒叙*/
            noName: false,                                  /*需不需要显示名字*/
            mode:false,                                     /*允许上传模式，默认html5 fromData 还有from模式*/
            afterUpload: null
        },
    ...
    $.extend(WeqiaUploader.prototype, {
        ...
        check : function(){
            ...
            $.each(files, function(i, el){
                ...
                var file = {"name":el.name, itemId: "", groupId:"", status: 0,"size":el.size};
                prepareFiles[i] = file;
            });
            if(!allowedTypes)
                return false;
        ...
        showError : function(errorMsg){
            if($.dialog)
                $.dialog({width: '250px',height:"80px",title:"提示",icon: 'error.gif',time:3,content:"<h3>"+errorMsg+"</h3>",min:false,max:false});
            else
                alert(errorMsg);
        },
        ...
        uploadData : function(filedata){
            ...
            var item_id = "" + time + name;
            var prepareFiles = {"name":name, itemId: "", groupId:time, status: 0,"size":size};
    ...
    $.fn.weqiaUpload = function(options){
        ...
        this.each(function(i, el){
            ...
            if ( !uploader ) {
                options = $.extend(options, {"uploadEl": el});
    ...
    $.extend(WeqiaFileViewer.prototype, {
        ...
        choose: function(index){
            ...
            if(image){
                ...
                img.load(function(){
                    ...
                    var data = {width: this.width, hight: this.height, angle: 0};
                    $(this).data("data", data);
                });
        ...
        sourceImageView: function(url){
            ...
            right_btn.click(function(){
                ...
                sourceUrl.rotate({angle:sourceUrlAngle});
...
//			view_div.css({"width":mWidth});
        ...
        jplayer: function(){
            ...
            jp_container.css({"width":playWidth});
            ...
            if(this.settings.playSimpl == true){
                toggles.css({"width":"30px", "right":"5px"});
            }
        ...
        rotate: function(imgTag, angle){
            ...
            imgTag.css({"position": "absolute", "top": imgTop, "left": imgLeft});
            parent.css("height", div_hight);
            imgTag.rotate({angle:angle});
            data.angle = angle;
        },
        ...
        chooseBoxShift: function(n){
            ...
            choose_box.css({"margin-left": -m_left});
        },
    ...
    var WeqiaPage = function(options){
        ...
        var defaults = {
            schFun : null,							/* 查询函数   */
            pagingMode : "tradition",				/* 分页模式。目录支持tradition(传统分页)*/
            pageSize : 10,                          /* 每页记录数   */
            pageSizeSet : true,                     /* 设置每页记录数   */
            pagination : 5,							/* 显示页码个数   */
            formable: false,						/* 是否响应表单form */
            pageTotalItem:false,                    /* 是否查询总条数 默认关闭*/
            schForm : null,							/* 查询form对象。在formable为true生效 */
            currPageEl: null,						/* 表单元素:当前页。在formable为true生效 */
            totalPageEl: null,						/* 表单元素:共页数。在formable为true生效 */
            flPage : true,							/* 是否首尾页标   */
            npPage : true,							/* 是否上下页标   */
            htNum : true,							/* 是否显示首尾数字页标*/
            autoHide: true,							/* 当没有数据的时候是否自动隐藏   */
            margin: null,							/* 间距   */
            nvgClass : "nvg",						/* 分页导航条样式  */
            flBtnClass : "btnPage",					/* 首尾btn样式  */
            npBtnClass: "btnPage",					/* 上下btn样式  */
            numBtnClass: "",						/* 页码btn样式  */
            activeClass: "current",	 				/* 页码激活样式  */
    ...
    $.extend(WeqiaPage.prototype, {
        ...
        createFirstBtn: function(){
            ...
            if(this.isFirstPage())
                first_page.css({'cursor':'default', 'color':'#aaaaaa'});
            return first_page;
        },
        ...
        createNextBtn: function(){
            ...
            if(this.isLastPage())
                next_page.css({'cursor':'default', 'color':'#aaaaaa'});
            return next_page;
        },
        ...
        createLastBtn: function(){
            ...
            if(this.isLastPage())
                last_page.css({'cursor':'default', 'color':'#aaaaaa'});
            return last_page;
        },
        ...
        createPrevBtn: function(){
            ...
            if(this.isFirstPage())
                prev_page.css({'cursor':'default', 'color':'#aaaaaa'});
            return prev_page;
        },
        ...
        html : function(){
            ...
            var rtPagination = 0, ltPagination = 0;
            var dynamic = false;
...
//    			return true;
        ...
        retrieve: function(schCond){
            ...
            if(schCond){
                var $this = this;
                //20150325
                $wq.loadData({url:this.getUrl("contact"), data:schCond, dataName: "query",loop:"false",
                    handle: function(data){
                        $this.handleLoadContactData(data);
                    }
                });
                if(this.settings.retType != 1){
                    var dpItems = $wq.getJsonData({url:this.getUrl("department"), data:schCond, dataName: "query", key: "result"});
                    this.handleLoadDpData(dpItems);
                }

                if(this.settings.isProjectTask && this.settings.isProjectTask != 0){
                    schCond = $.extend(schCond, {"project_id":this.settings.isProjectTask});
                    $wq.loadData({url:$this.getUrl("projectmans"), data:schCond, dataName: "query",key:"list",loop:"false",
                        handle: function(data){
                            $this.handleLoadContactData(data);
                        }
                    });
        ...
        discussretrieve: function(schCond){
            ...
            if(schCond){
                ...
                var $this = this;
                //20150401
                $wq.loadData({url:this.getUrl("discussman"), data:schCond, dataName: "query",loop:"false",
                    handle: function(data){
                        $this.handleLoadContactData(data);
                    }
                });
        ...
        otherRetrieve: function(url,schCond,dataName){
            ...
            if(schCond){
                ...
                var $this = this;
                //20150401
                $wq.loadData({url:url, data:schCond, dataName: dataName,loop:"false",
                    handle: function(data){
                        $this.handleLoadContactData(data);
                    }
                });
...
//			var s1 = inputElem.get(0).scrollTop;
        ...
        touchAt: function(){
            ...
            var at = {index: atIndex, cursor: cursorPos, cond: cond};
            //this.trigger.data("atdata", at);
            return at;
        },
    ...
    var wqretrieveExtend = {
        ...
        // },
            ...
            if(options&&options.coId){
                ...
                var tree = $wq.tree({selector: cont_company_root, text: coName, unfold: true});
                var root = tree.getRoot();
                $this.loadDpEmployee({"name": coName,"company_id":coId});
            }else{
                //20160830 增加选择全公司
                if(this.settings.choosecCompany == true){
                    ...
                    var tree = $wq.tree({selector: cont_root, text: "全公司", unfold: true,choosecom:1});
                    var root = tree.getRoot();
                    if(!options || !options.dpId){
                        root.click(function(){
                            $this.loadDpEmployee({"name": "全公司"});
                        });
                    }
                    ...
                    //20150409  pedding
                    cont_root.children().remove();
                    var tree = $wq.tree({selector: cont_root, text: "全公司", unfold: true});
                    var root = tree.getRoot();
                    if(!options || !options.dpId){
                        root.click(function(){
                            $this.loadDpEmployee({"name": "全公司"});
            ...
            if(dpItems && dpItems.length){
                $.each(dpItems, function(i, el){
                    ...
                    dpNode.click(function(){
                        ...
                        if(options&&options.coId){
                            $this.loadDpEmployee({"id": dpId, "name": dpName,"company_id":coId});
                        }else{
                            $this.loadDpEmployee({"id": dpId, "name": dpName});
                        }
            ...
            if(old.length == 0){
                var UnDepartment =  tree.addChildNode({text: "未分配部门", value: -1});
        ...
        handleLoadLabelData: function(lbItems,options){
            ...
            if(lbItems && lbItems.length){
                $.each(lbItems, function(i, el){
                    ...
                    //20151014 增加最大长度
                    var tree = $wq.tree({selector: cont_label_root, text: title, unfold: true,textMax:100});
                    var root = tree.getRoot();
                    ...
                    root.click(function(){
                        //var item = $(this);
                        //20150410pending
                        $this.loadLabelEmployee({"id": 0, "name": title,"lid":lid});
                    });
                    ...
                    if($this.settings.selectDp == true){
                        ...
                        node_obj.data("lb",{"title":title,"lid":lid});
        ...
        handleLoadCompanyData: function(cos){
            ...
            if(cos && cos.length){
                $.each(cos, function(i, el){
                    ...
                    var root = tree.getRoot();
                    root.click(function(){
                        var options = {"root":cont_company_root,"coName":coName,"coId":coId};
        ...
        handleLoadWorkerData:function(data){
            ...
            var tree = $wq.tree({selector: cont_worker_root, text: "全体工人", unfold: true,allWorker:1});
            ...
            if(data && data.length){
                $.each(data, function(i, el){
                    ...
                    if(parentId){
                        ...
                        dpNode.click(function(){
                            console.log($(this))
                            var options = {"root":this.target,"name":name,"id":id,"type":type,"tree":this};
                            $this.loadGroups(options);
                            $this.loadWorkerManData({projectId:id,name:name})
                        });
                ...
                $.each(groups, function(i, el){
                    ...
                    var dpNode = tree.addProjectChildNode(parems);;
                        ...
                        dpNode.click(function(){
                            var id = this.value();
                            var name = this.text();
                            $this.loadWorkerManData({groupId:id,name:name})
                        });
        ...
        loadDepartment: function(options){
            ...
            //data = {"company_id":4}
            if(options&&options.coId){
                data = {"company_id":options.coId}
            }

            var authType = this.settings.authType;
            if(authType&&authType=="auth"){
                data = $.extend(data, {"authType":"auth"});
                var busType = this.settings.busType;
                data = $.extend(data, {"busType":busType});
            }
            var dpItems = $wq.getJsonData({url:this.getUrl("department"), data:data, dataName: "query", key: "result"});
            if(options){
        ...
        loadProjectMan: function(pId,keyword){
            var data = {project_id:pId,schCond:keyword};
            var manItems = $wq.getJsonData({url:this.getUrl("projectmans"),data:data,dataName:"query",key:"list"});
        ...
        loadCompany: function(){
            var data;
            var coItems = $wq.getJsonData({url:this.getUrl("findallowncompany"), data:data, dataName: "query", key: "result"});
        ...
        loadLabel: function(options){
            ...
            if(companyType&&companyType=="own"){
                ...
                if(options&&options.coId){
                    data = {"company_id":options.coId,"companyType":companyType};
                }
            }

            var lbItems = $wq.getJsonData({url:this.getUrl("findLabel"), data:data, dataName: "query", key: "result"});
            //20150410 options
            if(options){
        ...
        loadFriendsModule: function(options){
            ...
            friendsSelectBar.find(".letter_bean").unbind().click(function(){
                var h = $(this).html();
                $this.loadFriends({"friendFletter":h});
            });
        },

        //取得工人模块
        loadWorkModule: function(options){
            var coItems = $wq.getJsonData({url:this.getUrl("workerContact"), dataName: "query", key: "result"});
        ...
        loadDpEmployee: function(dp){
            ...
            if(dp.company_id){
                var schCond = {"dpId":dp.id,"company_id":dp.company_id};
            }else{
                var schCond = {"dpId":dp.id};
            }
            ...
            var authType = this.settings.authType;
            if(authType&&authType=="auth"){
                schCond = $.extend(schCond, {"authType":"auth"});
            }
...
//        			});
            ...
            //20150410 增加lid
            if(lb.lid){
                var schCond = {"lbId":lb.id,"lid":lb.lid};
            }else{
                var schCond = {"lbId":lb.id};
            }
            //20150410 labelBean
            var url = this.getUrl("labelcontact");
            var labelBean = {"url":url};
...
//        			});
            ...
            if(fs.friendFletter){
                var schCond = {"friendFletter":fs.friendFletter};
            }else{
                var schCond = {};
            }
            //20150410 labelBean
            var url = this.getUrl("friendcontact");
            var friendBean = {"url":url};
...
//                    });
                ...
                var schCond = {"groupId":g.groupId,"projectId":g.projectId};

            //20150410 labelBean
            var url = this.getUrl("findWorkers");
            var workerBean = {"url":url};
        	...
        	retrieve: function(schCond,labelBean,friendBean,workerBean){
                ...
                if(!schCond){
        			if(!this.settings.allowNull)
        				return null;
        			schCond = {"schType":retType, "retAll": true,"pageSize":50};
        		}else{
     ...
     */
    var wqFaceHandler = {
        faces: { "害羞": "f000.png","微笑": "f001.png","撇嘴": "f002.png",
            "色": "f003.png","发呆": "f004.png","得意": "f005.png","流泪": "f006.png",
            "闭嘴": "f007.png","睡": "f008.png","大哭": "f009.png","尴尬": "f010.png",
            "发怒": "f011.png","调皮": "f012.png","呲牙": "f013.png","惊讶": "f014.png",
            "难过": "f015.png","酷": "f016.png","冷汗": "f017.png","抓狂": "f018.png",
            "吐": "f019.png","偷笑": "f020.png","可爱": "f021.png","白眼": "f022.png",
            "傲慢": "f023.png","饥饿": "f024.png","困": "f025.png","惊恐": "f026.png",
            "流汗": "f027.png","憨笑": "f028.png","大兵": "f029.png","奋斗": "f030.png",
            "咒骂": "f031.png","疑问": "f032.png","嘘": "f033.png","晕": "f034.png",
            "折磨": "f035.png","衰": "f036.png","骷髅": "f037.png","敲打": "f038.png",
            "再见": "f039.png","擦汗": "f040.png","抠鼻": "f041.png","鼓掌": "f042.png",
            "糗大了": "f043.png","坏笑": "f044.png","左哼哼": "f045.png","右哼哼": "f046.png",
            "哈欠": "f047.png","鄙视": "f048.png","委屈": "f049.png","快哭了": "f050.png",
            "阴险": "f051.png","亲亲": "f052.png","吓": "f053.png","可怜": "f054.png",
            "菜刀": "f055.png","西瓜": "f056.png","啤酒": "f057.png","篮球": "f058.png",
            "乒乓球": "f059.png","咖啡": "f060.png","饭": "f061.png","猪头": "f062.png",
            "玫瑰": "f063.png","凋谢": "f064.png","示爱": "f065.png","爱心": "f066.png",
            "心碎": "f067.png","蛋糕": "f068.png","闪电": "f069.png","炸弹": "f070.png",
            "刀": "f071.png","足球": "f072.png","飘虫": "f073.png","便便": "f074.png",
            "月亮": "f075.png","太阳": "f076.png","礼物": "f077.png","拥抱": "f078.png",
            "强": "f079.png","弱": "f080.png","握手": "f081.png","胜利": "f082.png",
            "抱拳": "f083.png","勾引": "f084.png","拳头": "f085.png","差劲": "f086.png",
            "爱你": "f087.png","NO": "f088.png","OK": "f089.png","爱情": "f090.png",
            "飞吻": "f091.png","跳跳": "f092.png","发抖": "f093.png","怄火": "f094.png",
            "转圈": "f095.png","磕头": "f096.png","回头": "f097.png","跳绳": "f098.png",
            "挥手": "f099.png","哈哈": "f100.png","口罩": "f101.png","大笑": "f102.png",
            "闭眼": "f103.png","吃惊": "f104.png","脸红": "f105.png","恐怖": "f106.png",
            "思考": "f107.png","眨眼": "f108.png","满足": "f109.png","不高兴": "f110.png",
            "恶魔": "f111.png","幽灵": "f112.png","心型礼盒": "f113.png","合掌": "f114.png",
            "肌肉": "f115.png","钱": "f116.png","生日": "f117.png","派对": "f118.png",
            "皇冠": "f119.png"},
        imageServer: "",
...
//		        			$this.settings.clickFace.call(this);
     ...
     */
    var wqZoneHandler = {
        zone: [{"citys":[{"cityId":1,"cityName":"北京市"}],"provName":"北京市","provId":1},{"citys":[{"cityId":2,"cityName":"天津市"}],"provName":"天津市","provId":2},{"citys":[{"cityId":3,"cityName":"上海市"}],"provName":"上海市","provId":3},{"citys":[{"cityId":4,"cityName":"重庆市"}],"provName":"重庆市","provId":4},{"citys":[{"cityId":5,"cityName":"石家庄市"},{"cityId":6,"cityName":"衡水市"},{"cityId":7,"cityName":"邢台市"},{"cityId":8,"cityName":"邯郸市"},{"cityId":9,"cityName":"沧州市"},{"cityId":10,"cityName":"唐山市"},{"cityId":11,"cityName":"廊坊市"},{"cityId":12,"cityName":"秦皇岛市"},{"cityId":13,"cityName":"承德市"},{"cityId":14,"cityName":"保定市"},{"cityId":15,"cityName":"张家口市"}],"provName":"河北省","provId":5},{"citys":[{"cityId":16,"cityName":"济南市"},{"cityId":17,"cityName":"聊城市"},{"cityId":18,"cityName":"德州市"},{"cityId":19,"cityName":"淄博市"},{"cityId":20,"cityName":"滨州市"},{"cityId":21,"cityName":"东营市"},{"cityId":22,"cityName":"潍坊市"},{"cityId":23,"cityName":"烟台市"},{"cityId":24,"cityName":"威海市"},{"cityId":25,"cityName":"青岛市"},{"cityId":26,"cityName":"泰安市"},{"cityId":27,"cityName":"莱芜市"},{"cityId":28,"cityName":"济宁市"},{"cityId":29,"cityName":"菏泽市"},{"cityId":30,"cityName":"临沂市"},{"cityId":31,"cityName":"日照市"},{"cityId":32,"cityName":"枣庄市"}],"provName":"山东省","provId":6},{"citys":[{"cityId":33,"cityName":"沈阳市"},{"cityId":34,"cityName":"辽阳市"},{"cityId":35,"cityName":"铁岭市"},{"cityId":36,"cityName":"抚顺市"},{"cityId":37,"cityName":"鞍山市"},{"cityId":38,"cityName":"大连市"},{"cityId":39,"cityName":"本溪市"},{"cityId":40,"cityName":"丹东市"},{"cityId":41,"cityName":"朝阳市"},{"cityId":42,"cityName":"阜新市"},{"cityId":43,"cityName":"盘锦市"}],"provName":"辽宁省","provId":7},{"citys":[{"cityId":44,"cityName":"哈尔滨市"},{"cityId":45,"cityName":"绥化市"},{"cityId":46,"cityName":"伊春市"},{"cityId":47,"cityName":"佳木斯市"},{"cityId":48,"cityName":"鹤岗市"},{"cityId":49,"cityName":"七台河市"},{"cityId":50,"cityName":"双鸭山市"},{"cityId":51,"cityName":"牡丹江市"},{"cityId":52,"cityName":"鸡西市"},{"cityId":53,"cityName":"齐齐哈尔市"},{"cityId":54,"cityName":"大庆市"},{"cityId":55,"cityName":"黑河市"}],"provName":"黑龙江省","provId":8},{"citys":[{"cityId":56,"cityName":"南京市"},{"cityId":57,"cityName":"镇江市"},{"cityId":58,"cityName":"常州市"},{"cityId":59,"cityName":"无锡市"},{"cityId":60,"cityName":"苏州市"},{"cityId":61,"cityName":"徐州市"},{"cityId":62,"cityName":"连云港市"},{"cityId":63,"cityName":"淮安市"},{"cityId":64,"cityName":"宿迁市"},{"cityId":65,"cityName":"盐城市"},{"cityId":66,"cityName":"扬州市"},{"cityId":67,"cityName":"泰州市"},{"cityId":68,"cityName":"南通市"}],"provName":"江苏省","provId":9},{"citys":[{"cityId":69,"cityName":"杭州市"},{"cityId":70,"cityName":"绍兴市"},{"cityId":71,"cityName":"湖州市"},{"cityId":72,"cityName":"嘉兴市"},{"cityId":73,"cityName":"宁波市"},{"cityId":74,"cityName":"舟山市"},{"cityId":75,"cityName":"台州市"},{"cityId":76,"cityName":"金华市"},{"cityId":77,"cityName":"丽水市"},{"cityId":78,"cityName":"衢州市"},{"cityId":79,"cityName":"温州市"}],"provName":"浙江省","provId":10},{"citys":[{"cityId":80,"cityName":"西安市"},{"cityId":81,"cityName":"咸阳市"},{"cityId":82,"cityName":"渭南市"},{"cityId":83,"cityName":"延安市"},{"cityId":84,"cityName":"榆林市"},{"cityId":85,"cityName":"宝鸡市"},{"cityId":86,"cityName":"汉中市"},{"cityId":87,"cityName":"安康市"},{"cityId":88,"cityName":"商洛市"},{"cityId":89,"cityName":"铜川市"}],"provName":"陕西省","provId":11},{"citys":[{"cityId":90,"cityName":"太原市"},{"cityId":91,"cityName":"吕梁市"},{"cityId":92,"cityName":"忻州市"},{"cityId":93,"cityName":"朔州市"},{"cityId":94,"cityName":"大同市"},{"cityId":95,"cityName":"晋中市"},{"cityId":96,"cityName":"临汾市"},{"cityId":97,"cityName":"运城市"},{"cityId":98,"cityName":"阳泉市"},{"cityId":99,"cityName":"长治市"},{"cityId":100,"cityName":"晋城市"}],"provName":"山西省","provId":12},{"citys":[{"cityId":101,"cityName":"福州市"},{"cityId":102,"cityName":"莆田市"},{"cityId":103,"cityName":"宁德市"},{"cityId":104,"cityName":"南平市"},{"cityId":105,"cityName":"厦门市"},{"cityId":106,"cityName":"泉州市"},{"cityId":107,"cityName":"漳州市"},{"cityId":108,"cityName":"龙岩市"},{"cityId":109,"cityName":"三明市"}],"provName":"福建省","provId":13},{"citys":[{"cityId":110,"cityName":"广州市"},{"cityId":111,"cityName":"清远市"},{"cityId":112,"cityName":"韶关市"},{"cityId":113,"cityName":"梅州市"},{"cityId":114,"cityName":"汕头市"},{"cityId":115,"cityName":"汕尾市"},{"cityId":116,"cityName":"河源市"},{"cityId":117,"cityName":"深圳市"},{"cityId":118,"cityName":"珠海市"},{"cityId":119,"cityName":"潮州市"},{"cityId":120,"cityName":"揭阳市"},{"cityId":121,"cityName":"东莞市"},{"cityId":122,"cityName":"湛江市"},{"cityId":123,"cityName":"茂名市"},{"cityId":124,"cityName":"肇庆市"},{"cityId":125,"cityName":"云浮市"},{"cityId":126,"cityName":"佛山市"},{"cityId":127,"cityName":"中山市"},{"cityId":128,"cityName":"江门市"},{"cityId":129,"cityName":"阳江市"}],"provName":"广东省","provId":14},{"citys":[{"cityId":130,"cityName":"郑州市"},{"cityId":131,"cityName":"新乡市"},{"cityId":132,"cityName":"焦作市"},{"cityId":133,"cityName":"安阳市"},{"cityId":134,"cityName":"濮阳市"},{"cityId":135,"cityName":"鹤壁市"},{"cityId":136,"cityName":"许昌市"},{"cityId":137,"cityName":"漯河市"},{"cityId":138,"cityName":"驻马店市"},{"cityId":139,"cityName":"信阳市"},{"cityId":140,"cityName":"周口市"},{"cityId":141,"cityName":"平顶山市"},{"cityId":142,"cityName":"洛阳市"},{"cityId":143,"cityName":"三门峡市"},{"cityId":144,"cityName":"南阳市"},{"cityId":145,"cityName":"开封市"},{"cityId":146,"cityName":"商丘市"}],"provName":"河南省","provId":15},{"citys":[{"cityId":168,"cityName":"长沙市"},{"cityId":169,"cityName":"湘潭市"},{"cityId":170,"cityName":"株洲市"},{"cityId":171,"cityName":"益阳市"},{"cityId":172,"cityName":"岳阳市"},{"cityId":173,"cityName":"常德市"},{"cityId":174,"cityName":"湘西土家族苗族自治州"},{"cityId":175,"cityName":"娄底市"},{"cityId":176,"cityName":"怀化市"},{"cityId":177,"cityName":"衡阳市"},{"cityId":178,"cityName":"邵阳市"},{"cityId":179,"cityName":"郴州市"},{"cityId":180,"cityName":"永州市"},{"cityId":181,"cityName":"张家界市"}],"provName":"湖南省","provId":17},{"citys":[{"cityId":147,"cityName":"成都市"},{"cityId":148,"cityName":"乐山市"},{"cityId":149,"cityName":"凉山彝族自治州"},{"cityId":150,"cityName":"攀枝花市"},{"cityId":151,"cityName":"德阳市"},{"cityId":152,"cityName":"眉山市"},{"cityId":153,"cityName":"绵阳市"},{"cityId":154,"cityName":"阿坝藏族羌族自治州"},{"cityId":155,"cityName":"雅安市"},{"cityId":156,"cityName":"甘孜藏族自治州"},{"cityId":157,"cityName":"广元市"},{"cityId":158,"cityName":"遂宁市"},{"cityId":159,"cityName":"达州市"},{"cityId":160,"cityName":"巴中市"},{"cityId":161,"cityName":"南充市"},{"cityId":162,"cityName":"广安市"},{"cityId":163,"cityName":"内江市"},{"cityId":164,"cityName":"资阳市"},{"cityId":165,"cityName":"自贡市"},{"cityId":166,"cityName":"宜宾市"},{"cityId":167,"cityName":"泸州市"}],"provName":"四川省","provId":16},{"citys":[{"cityId":199,"cityName":"合肥市"},{"cityId":200,"cityName":"淮南市"},{"cityId":201,"cityName":"蚌埠市"},{"cityId":202,"cityName":"宿州市"},{"cityId":203,"cityName":"淮北市"},{"cityId":204,"cityName":"阜阳市"},{"cityId":205,"cityName":"毫州市"},{"cityId":206,"cityName":"六安市"},{"cityId":207,"cityName":"巢湖市"},{"cityId":208,"cityName":"滁州市"},{"cityId":209,"cityName":"芜湖市"},{"cityId":210,"cityName":"宣城市"},{"cityId":211,"cityName":"马鞍山市"},{"cityId":212,"cityName":"铜陵市"},{"cityId":213,"cityName":"黄山市"},{"cityId":214,"cityName":"安庆市"},{"cityId":215,"cityName":"池州市"}],"provName":"安徽省","provId":19},{"citys":[{"cityId":182,"cityName":"武汉市"},{"cityId":183,"cityName":"天门市"},{"cityId":184,"cityName":"孝感市"},{"cityId":185,"cityName":"仙桃市"},{"cityId":186,"cityName":"潜江市"},{"cityId":187,"cityName":"荆州市"},{"cityId":188,"cityName":"黄石市"},{"cityId":189,"cityName":"鄂州市"},{"cityId":190,"cityName":"咸宁市"},{"cityId":191,"cityName":"黄冈市"},{"cityId":192,"cityName":"襄樊市"},{"cityId":193,"cityName":"随州市"},{"cityId":194,"cityName":"十堰市"},{"cityId":195,"cityName":"神农架林区"},{"cityId":196,"cityName":"宜昌市"},{"cityId":197,"cityName":"恩施土家族苗族自治州"},{"cityId":198,"cityName":"荆门市"}],"provName":"湖北省","provId":18},{"citys":[{"cityId":227,"cityName":"海口市"},{"cityId":228,"cityName":"定安县"},{"cityId":229,"cityName":"文昌市"},{"cityId":230,"cityName":"西沙群岛"},{"cityId":231,"cityName":"琼海市"},{"cityId":232,"cityName":"万宁市"},{"cityId":233,"cityName":"屯昌县"},{"cityId":234,"cityName":"儋州市"},{"cityId":235,"cityName":"临高县"},{"cityId":236,"cityName":"澄迈县"},{"cityId":237,"cityName":"三亚市"},{"cityId":238,"cityName":"五指山市"},{"cityId":239,"cityName":"保亭黎族苗族自治县"},{"cityId":240,"cityName":"陵水黎族自治县"},{"cityId":241,"cityName":"乐东黎族自治县"},{"cityId":242,"cityName":"昌江黎族自治县"},{"cityId":243,"cityName":"白沙黎族自治县"},{"cityId":244,"cityName":"琼中黎族苗族自治县"},{"cityId":245,"cityName":"中沙群岛的岛礁及其海域"},{"cityId":246,"cityName":"南沙群岛"}],"provName":"海南省","provId":21},{"citys":[{"cityId":216,"cityName":"南昌市"},{"cityId":217,"cityName":"九江市"},{"cityId":218,"cityName":"景德镇市"},{"cityId":219,"cityName":"上饶市"},{"cityId":220,"cityName":"鹰潭市"},{"cityId":221,"cityName":"宜春市"},{"cityId":222,"cityName":"萍乡市"},{"cityId":223,"cityName":"新余市"},{"cityId":224,"cityName":"赣州市"},{"cityId":225,"cityName":"吉安市"},{"cityId":226,"cityName":"抚州市"}],"provName":"江西省","provId":20},{"citys":[{"cityId":263,"cityName":"贵阳市"},{"cityId":264,"cityName":"毕节地区"},{"cityId":265,"cityName":"六盘水市"},{"cityId":266,"cityName":"铜仁地区"},{"cityId":267,"cityName":"黔东南苗族侗族自治州"},{"cityId":268,"cityName":"黔南布依族苗族自治州"},{"cityId":269,"cityName":"安顺市"},{"cityId":270,"cityName":"黔西南布依族苗族自治州"},{"cityId":271,"cityName":"遵义市"}],"provName":"贵州省","provId":23},{"citys":[{"cityId":247,"cityName":"昆明市"},{"cityId":248,"cityName":"玉溪市"},{"cityId":249,"cityName":"曲靖市"},{"cityId":250,"cityName":"昭通市"},{"cityId":251,"cityName":"文山壮族苗族自治州"},{"cityId":252,"cityName":"红河哈尼族彝族自治州"},{"cityId":253,"cityName":"普洱市"},{"cityId":254,"cityName":"西双版纳傣族自治州"},{"cityId":255,"cityName":"大理白族自治州"},{"cityId":256,"cityName":"怒江傈僳族自治州"},{"cityId":257,"cityName":"丽江市"},{"cityId":258,"cityName":"迪庆藏族自治州"},{"cityId":259,"cityName":"楚雄彝族自治州"},{"cityId":260,"cityName":"临沧市"},{"cityId":261,"cityName":"保山市"},{"cityId":262,"cityName":"德宏傣族景颇族自治州"}],"provName":"云南省","provId":22},{"citys":[{"cityId":286,"cityName":"西宁市"},{"cityId":287,"cityName":"黄南藏族自治州"},{"cityId":288,"cityName":"海北藏族自治州"},{"cityId":289,"cityName":"海南藏族自治州"},{"cityId":290,"cityName":"海东地区"},{"cityId":291,"cityName":"果洛藏族自治州"},{"cityId":292,"cityName":"玉树藏族自治州"},{"cityId":293,"cityName":"海西蒙古族藏族自治州"}],"provName":"青海省","provId":25},{"citys":[{"cityId":272,"cityName":"兰州市"},{"cityId":273,"cityName":"白银市"},{"cityId":274,"cityName":"临夏回族自治州"},{"cityId":275,"cityName":"武威市"},{"cityId":276,"cityName":"张掖市"},{"cityId":277,"cityName":"酒泉市"},{"cityId":278,"cityName":"嘉峪关市"},{"cityId":279,"cityName":"金昌市"},{"cityId":280,"cityName":"天水市"},{"cityId":281,"cityName":"陇南市"},{"cityId":282,"cityName":"定西市"},{"cityId":283,"cityName":"平凉市"},{"cityId":284,"cityName":"庆阳市"},{"cityId":285,"cityName":"甘南藏族自治州"}],"provName":"甘肃省","provId":24},{"citys":[{"cityId":299,"cityName":"呼和浩特市"},{"cityId":300,"cityName":"乌兰察布市"},{"cityId":301,"cityName":"包头市"},{"cityId":302,"cityName":"巴彦淖尔市"},{"cityId":303,"cityName":"乌海市"},{"cityId":304,"cityName":"鄂尔多斯市"},{"cityId":305,"cityName":"呼伦贝尔市"},{"cityId":306,"cityName":"赤峰市"},{"cityId":307,"cityName":"锡林郭勒盟"},{"cityId":308,"cityName":"通辽市"},{"cityId":309,"cityName":"兴安盟"},{"cityId":310,"cityName":"阿拉善盟"}],"provName":"内蒙古自治区","provId":27},{"citys":[{"cityId":294,"cityName":"银川市"},{"cityId":295,"cityName":"吴忠市"},{"cityId":296,"cityName":"石嘴山市"},{"cityId":297,"cityName":"中卫市"},{"cityId":298,"cityName":"固原市"}],"provName":"宁夏回族自治区","provId":26},{"citys":[{"cityId":318,"cityName":"南宁市"},{"cityId":319,"cityName":"崇左市"},{"cityId":320,"cityName":"百色市"},{"cityId":321,"cityName":"钦州市"},{"cityId":322,"cityName":"北海市"},{"cityId":323,"cityName":"贵港市"},{"cityId":324,"cityName":"玉林市"},{"cityId":325,"cityName":"防城港市"},{"cityId":326,"cityName":"桂林市"},{"cityId":327,"cityName":"贺州市"},{"cityId":328,"cityName":"梧州市"},{"cityId":329,"cityName":"柳州市"},{"cityId":330,"cityName":"来宾市"},{"cityId":331,"cityName":"河池市"}],"provName":"广西壮族自治区","provId":29},{"citys":[{"cityId":311,"cityName":"拉萨市"},{"cityId":312,"cityName":"那曲地区"},{"cityId":313,"cityName":"昌都地区"},{"cityId":314,"cityName":"山南地区"},{"cityId":315,"cityName":"日喀则地区"},{"cityId":316,"cityName":"阿里地区"},{"cityId":317,"cityName":"林芝地区"}],"provName":"西藏自治区","provId":28},{"citys":[{"cityId":350,"cityName":"香港特别行政区"}],"provName":"香港特别行政区","provId":31},{"citys":[{"cityId":332,"cityName":"乌鲁木齐市"},{"cityId":333,"cityName":"昌吉回族自治州"},{"cityId":334,"cityName":"石河子市"},{"cityId":335,"cityName":"博尔塔拉蒙古自治州"},{"cityId":336,"cityName":"克拉玛依市"},{"cityId":337,"cityName":"塔城地区"},{"cityId":338,"cityName":"伊犁哈萨克自治州"},{"cityId":339,"cityName":"阿勒泰地区"},{"cityId":340,"cityName":"吐鲁番地区"},{"cityId":341,"cityName":"哈密地区"},{"cityId":342,"cityName":"巴音郭楞蒙古自治州"},{"cityId":343,"cityName":"阿克苏地区"},{"cityId":344,"cityName":"喀什地区"},{"cityId":345,"cityName":"阿拉尔市"},{"cityId":346,"cityName":"图木舒克市"},{"cityId":347,"cityName":"五家渠市"},{"cityId":348,"cityName":"克孜勒苏柯尔克孜自治州"},{"cityId":349,"cityName":"和田地区"}],"provName":"新疆维吾尔自治区","provId":30},{"citys":[{"cityId":379,"cityName":"长春市"},{"cityId":380,"cityName":"吉林市"},{"cityId":381,"cityName":"吉林市"},{"cityId":382,"cityName":"延边朝鲜族自治州"},{"cityId":383,"cityName":"通化市"},{"cityId":384,"cityName":"白山市"},{"cityId":385,"cityName":"四平市"},{"cityId":386,"cityName":"辽源市"},{"cityId":387,"cityName":"白城市"},{"cityId":388,"cityName":"松原市"}],"provName":"吉林省","provId":34},{"citys":[{"cityId":351,"cityName":"澳门特别行政区"}],"provName":"澳门特别行政区","provId":32},{"citys":[{"cityId":352,"cityName":"台北市"},{"cityId":353,"cityName":"基隆市"},{"cityId":354,"cityName":"台北县"},{"cityId":355,"cityName":"宜兰县"},{"cityId":356,"cityName":"新竹市"},{"cityId":357,"cityName":"新竹县"},{"cityId":358,"cityName":"桃园县"},{"cityId":359,"cityName":"苗栗县"},{"cityId":360,"cityName":"台中市"},{"cityId":361,"cityName":"台中县"},{"cityId":362,"cityName":"彰化县"},{"cityId":363,"cityName":"南投市"},{"cityId":364,"cityName":"南投县"},{"cityId":365,"cityName":"嘉义市"},{"cityId":366,"cityName":"嘉义县"},{"cityId":367,"cityName":"云林县"},{"cityId":368,"cityName":"台南市"},{"cityId":369,"cityName":"台南县"},{"cityId":370,"cityName":"高雄市"},{"cityId":371,"cityName":"高雄县"},{"cityId":372,"cityName":"澎湖县"},{"cityId":373,"cityName":"马祖县"},{"cityId":374,"cityName":"金门县"},{"cityId":375,"cityName":"屏东县"},{"cityId":376,"cityName":"台东县"},{"cityId":377,"cityName":"台东县"},{"cityId":378,"cityName":"花莲县"}],"provName":"台湾省","provId":33}],
...
//		},
    ...
    $wq.loading_start = function(content,src,root){
        ...
        $(".overlay").css({"height": h,'display':'block','opacity':'0.6'});
        $(".showbox").stop(true).animate({'margin-top':hw/2,'opacity':'1'},200);
    ...
    $wq.loading_end = function(){
        ...
        var hw= $(window).height();
        if($(".showbox")){
            $(".showbox").stop(true).animate({'margin-top':hw/2-50,'opacity':'0'},400).remove();
        }
        if($(".overlay")){
            $(".overlay").stop(true).animate({'display':'none','opacity':'0'},400).remove();
        }
    };
