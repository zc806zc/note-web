...
// 错误示例???? =============
// console.log(
//   sortUtil.bubbleForce(arr),
//   sortUtil.bubblePos(arr)
// );

console.log(sortUtil.bubbleForce(arr));
console.log(sortUtil.bubblePos(arr));
console.log(sortUtil.bubbleDirecrion(arr));
console.log(sortUtil.shell(arr));
console.log(sortUtil.radix(arr));
console.log(sortUtil.bucket(arr, 4));
console.log(sortUtil.insertion(arr));
console.log(sortUtil.insertionBinary(arr));
console.log(sortUtil.quick(arr, 0, arr.length - 1));
console.log(sortUtil.quickSlice(arr)); // 存在BUG，放在selection前
console.log(sortUtil.selection(arr));
console.log(sortUtil.merge(arr));
console.log(sortUtil.counting(arr));
console.log(sortUtil.heap(arr));
